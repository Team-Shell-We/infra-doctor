...
Contributions are always welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for setup, how to test your changes, and how to add a diagnostic rule or a translation.
